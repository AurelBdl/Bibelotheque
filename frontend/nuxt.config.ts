...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      title: "La Bibelothèque",
      meta: [
        { property: "og:type", content: "website" },
        { property: "og:title", content: "La Bibelothèque" },
        { property: "og:site_name", content: "La Bibelothèque" },
        {
          property: "og:description",
          content: "La Bibelothèque is a recipe management app for your kitchen.",
        },
        {
          property: "og:image",
          content:
  ...
  pwa: {
    ...
    manifest: {
      name: "La Bibelothèque",
      short_name: "Bibelothèque",
      id: "/",
      start_url: "/",
      scope: "/",
      display: "standalone",
